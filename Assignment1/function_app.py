...
@app.route(route="AddEmployeeDetails", auth_level=func.AuthLevel.ANONYMOUS)
...
@app.route(route="DisplayEmployeeDetails", auth_level=func.AuthLevel.ANONYMOUS)
...
@app.route(route="DeleteEmployeeDetails", auth_level=func.AuthLevel.ANONYMOUS)
